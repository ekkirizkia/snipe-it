...
{{-- Page title --}}
@section('title')
    {{-- {{trans('general.accept', ['asset' => $acceptances->first()->bulk_id])}} --}}
    Penyerahan bulk asset ID {{ $acceptances->first()->bulk_id }}
    @parent
@stop
            ...
            <div class="col-sm-12 col-sm-offset-1 col-md-10 col-md-offset-1">
                <div class="panel box box-default">
                    <div class="box-header with-border">
                        <h2 class="box-title">
                            Penyerahan bulk asset kepada {{ $acceptances->first()->assignedTo?->name }}
                    ...
                    <div class="box-body">
                        <div class="col-md-12" style="padding-top: 5px; padding-bottom: 15px;">
                            <div style="background-color: rgba(211,211,211,0.25); padding: 0px 10px 10px 10px; border: lightgrey 1px solid;">
                                {!!  str_replace('<p>', '<p dir="auto">', Helper::parseEscapedMarkedown($acceptances->first()->checkoutable->getEula())) !!}
                            </div>
                        </div>
                        <div class="col-md-12">
                            <h3>Daftar Item</h3>
